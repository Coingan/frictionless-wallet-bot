...
def notify(message, tx_type=None):
    ...
    if tx_type == "incoming":
        ...
        keyboard = [[InlineKeyboardButton("💰 Contribute Here", url="https://app.frictionless.network/contribute")]] #changed create OTC offer for campaign
    else:
        keyboard = []
...
def send_campaign_summary():
    ...
    try:
        ...
        fig.savefig(img_path, bbox_inches='tight', dpi=Config.IMAGE_DPI, 
                   facecolor='transparent', edgecolor='none', #changed face color from 1a1a1a
